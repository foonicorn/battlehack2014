...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Payment', fields ['challenge', 'type']
        db.create_unique(u'paypal_payment', ['challenge_id', 'type'])


    def backwards(self, orm):
        # Removing unique constraint on 'Payment', fields ['challenge', 'type']
        db.delete_unique(u'paypal_payment', ['challenge_id', 'type'])
    ...
    models = {
        ...
        u'paypal.payment': {
            'Meta': {'unique_together': "(('challenge', 'type'),)", 'object_name': 'Payment'},
