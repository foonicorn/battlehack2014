...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_attendee', (
        ...
        db.send_create_signal(u'core', ['Attendee'])

        # Adding unique constraint on 'Attendee', fields ['challenge', 'type']
        db.create_unique(u'core_attendee', ['challenge_id', 'type'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Attendee', fields ['challenge', 'type']
        db.delete_unique(u'core_attendee', ['challenge_id', 'type'])

        # Deleting model 'Attendee'
        db.delete_table(u'core_attendee')
